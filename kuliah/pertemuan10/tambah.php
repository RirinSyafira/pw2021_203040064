    ...
    <div class="row card">
      <form action="" method="POST" class="col s12">
        <div class="row">
          ...
          <button type="submit" class="waves-effect waves-light btn" style="text-decoration: none; color: white;"><a class="link" href="latihan3.php">Kembali</a></button>
